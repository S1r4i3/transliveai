  ...
  head: () => ({
    meta: [
      ...
      { title: "Translive — One video. Every language. Zero excuses." },
      {
        name: "description",
        content:
          "AI video & audio translation with lip-sync in 42 languages. Voice cloning, vocal remover, 0.4s latency.",
      },
      { property: "og:title", content: "Translive — Every language. One voice. Yours." },
      {
        property: "og:description",
        content: "AI video translation with lip-sync in 42 languages. Sounds like you.",
      },
