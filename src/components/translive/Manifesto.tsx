  ...
  return (
    <section ref={secRef} className="relative py-32 md:py-48 px-6 md:px-10">
      <div className="max-w-[1200px] mx-auto">
        ...
        <h2 className="font-display text-[clamp(2rem,5.5vw,4.5rem)] leading-[1.05] tracking-[-0.03em]">
          {words.map((w, i) => {
            const text = typeof w === "string" ? w : w.text;
            const flicker = typeof w === "object" && Array.isArray((w as { flicker?: string[] | boolean }).flicker) ? (w as { flicker: string[] }).flicker : null;
            ...
            return (
              <span
                ...
                style={{
                  color: lit ? "transparent" : "rgba(250,248,245,0.18)",
                  backgroundImage: lit ? "linear-gradient(120deg,#faf8f5 0%,#d4a853 60%,#b8934a 100%)" : "none",
