    ...
    <section id="demo" className="relative py-24 md:py-32 px-6 md:px-10">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid md:grid-cols-[1fr_1.4fr] gap-10 md:gap-16 items-start">
          ...
          <div className="glass-panel p-6 md:p-8" data-cursor="అ→A">
            ...
            <div className="mt-5 flex items-center justify-between">
              ...
              <button
                onClick={play}
                data-cursor="PLAY"
                className="magnetic-btn inline-flex items-center gap-2 rounded-full bg-gold px-5 py-2.5 text-sm font-medium text-ink shadow-[0_0_30px_rgba(212,168,83,0.4)]"
              >
                <span className="w-0 h-0 border-y-[6px] border-y-transparent border-l-[9px] border-l-ink" />
